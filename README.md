...
| ---: | ---: | :---: | :---: | :---: |
| keksiqc/configarr | 72MB | 1000:1000 | ✅ | amd64, arm64 |
...
services:
  configarr:
    image: "keksiqc/configarr:1.25.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
# REGISTRIES ☁️
```
docker pull keksiqc/configarr:1.25.0
docker pull ghcr.io/keksiqc/configarr:1.25.0
docker pull quay.io/keksiqc/configarr:1.25.0
```
...
*created 31.03.2026, 10:12:34 (CET)*