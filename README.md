...
services:
  configarr:
    image: "keksiqc/configarr:1.24.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
# REGISTRIES ☁️
```
docker pull keksiqc/configarr:1.24.0
docker pull ghcr.io/keksiqc/configarr:1.24.0
docker pull quay.io/keksiqc/configarr:1.24.0
```
...
*created 10.03.2026, 06:36:42 (CET)*