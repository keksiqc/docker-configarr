...
| ---: | ---: | :---: | :---: | :---: |
| keksiqc/configarr | 140MB | 1000:1000 | ✅ | amd64, arm64 |
...
services:
  configarr:
    image: "keksiqc/configarr:1.21.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
# REGISTRIES ☁️
```
docker pull keksiqc/configarr:1.21.0
docker pull ghcr.io/keksiqc/configarr:1.21.0
docker pull quay.io/keksiqc/configarr:1.21.0
```
...
*created 18.02.2026, 07:34:45 (CET)*